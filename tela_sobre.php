...
<!DOCTYPE php>
  <php lang="pt-br">
    <head>
      ...
      <!-- LINK CSS -->
      <link rel="stylesheet" href="./tela_sobre.css">
...
<body>
  ...
  <section id="danyvia">
        <h2 id="titulos">Sobre a Empresa</h2>
    <p style="font-size: 20px;">A nossa empresa é especializada em fornecer produtos de qualidade para crianças de 6 meses <br> a 12 anos,
     visando o conforto e utilidade no cotidiano de quem usa os nossos produtos. </p>
    <h2 id="titulos">Nossos Serviços</h1>
    <ul>
        <li style="font-size: 20px;">• Entrega rápida do produto</li>
        <li style="font-size: 20px;">• Vendas locais e regionais</li>
        <li style="font-size: 20px;">• Importações nacionais</li>
    </ul>
    <h2 id="titulos">Nossos Valores</h1>
    <ul>
        <li style="font-size: 20px;">• Respeito ao cliente</li>
        <li style="font-size: 20px;">• Conforto</li>
        <li style="font-size: 20px;">• Compromisso com a qualidade</li>
    </ul>
    </section>
